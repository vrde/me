...
<div {style}>
  ...
  <p>
    ...
    networking (not the one with business cards), hardware, and open source.
    This page is an overview on things I work on and care about. Feel free to
  ...
  <ul>
    <li>
      ...
      is pretty fun. This website is built with svelte—yep that's overkill—but.
    </li>
    <li>
